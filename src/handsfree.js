(function (global, factory) {
  ...
  var defaultConfig = {
    ...
    autostart: false,
    // Use CDN by default
    assetsPath: 'https://unpkg.com/handsfree@8.4.3/build/lib/assets',
    ...
    onFrame({
      ...
      hands.multiHandLandmarks.forEach((landmarks, n) => {
        ...
        this.handsfree.TweenMax.to(this.tween[hand], 1, {
          ...
          y: hands.multiHandLandmarks[n][21].y * window.outerHeight - 100 * this.config.speed.y - window.outerHeight * this.config.speed.y / 2 + window.outerHeight / 2 + this.config.offset.y,
          overwrite: true,
          ease: 'linear.easeNone',
          immediate: true
        });
